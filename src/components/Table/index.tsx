...
import { PlayerWithPositionRatings } from '@/types/global.types';
import { cn } from '@/utils/helpers';

export function Table({ players }: { players: PlayerWithPositionRatings[] }) {
  ...
  function selectFilter(
    row: Row<PlayerWithPositionRatings>,
    columnId: string,
    value: any
  ) {
                ...
                {headerGroup.headers.map((header) => (
                  <th
                    ...
                    className={cn(
                      ...
                      ['nationality'].includes(header.id) && 'min-w-9',
